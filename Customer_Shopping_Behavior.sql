...
-- Q7. Segment customer into new, Returning and Loyal based on their total number of pervious
...
-- Q8. What are the top 3 most purchased products within each year.
...
-- Q9. Are customers who are repete buyers (more that 5 previous purchases) also likely to 
-- subscribe ?

select subscription_status, COUNT(customer_id) as repete_buyers
from customer
